...
class Config(object):
    ...
    NAME = 'Waste'  # Override in sub-classes

    # NUMBER OF GPUs to use
    GPU_COUNT = 1
    IMAGES_PER_GPU = 1

    # Number of training steps per epoch So, don't set this too small to avoid
    # spending a lot of time on validation stats.
    ...
    NUM_CLASSES = 7  # Override in sub-classes
